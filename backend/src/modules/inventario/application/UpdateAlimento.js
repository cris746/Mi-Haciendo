class UpdateAlimento {
  ...
  async execute(id, data) {
    ...
    if (!id) throw new Error('El id del alimento es obligatorio');
    ...
    return await this.inventarioRepository.updateAlimento(id, {
      ...(nombre && { nombre }),
