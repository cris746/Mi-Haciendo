    ...
    <div className="space-y-6">
      ...
      {activeTab === 'resumen' ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {(activeTab === 'alimentos' ? alimentos : medicamentos).map((item) => (
          ...
          {(activeTab === 'alimentos' ? alimentos : medicamentos).length === 0 && (
            <div className="col-span-full py-10">
              <EmptyState 
                title={activeTab === 'alimentos' ? 'No hay alimentos registrados' : 'No hay medicamentos registrados'}
                message={activeTab === 'alimentos' 
                  ? 'Registra alimentos para controlar el stock y las raciones de la hacienda.' 
                  : 'Registra medicamentos para controlar stock, vencimientos y aplicaciones sanitarias.'}
              />
            </div>
          )}
        </div>
            ...
            <form onSubmit={handleItemSubmit} className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input className="input" required placeholder={activeTab === 'alimentos' ? 'ej. kg, sacos' : 'ej. ml, frascos'} value={itemData.unidadMedida} onChange={e => setItemData({...itemData, unidadMedida: e.target.value})} />
                </div>
              </div>
              <div className="grid grid-cols-2 gap-4">
                <div>
